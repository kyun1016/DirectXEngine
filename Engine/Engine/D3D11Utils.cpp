...
bool D3D11Utils::CreateDepthBuffer(
	Microsoft::WRL::ComPtr<ID3D11Device>& device, int screenWidth, int screenHeight,
	UINT& numQualityLevels, Microsoft::WRL::ComPtr<ID3D11DepthStencilView>& depthStencilView) {
...
void D3D11Utils::D3D11Utils::CreateVertexShaderAndInputLayout(
...
void D3D11Utils::CreateTexture(
	Microsoft::WRL::ComPtr<ID3D11Device>& device, const std::string filename,
...
void D3D11Utils::CreateCubemapTexture(
	Microsoft::WRL::ComPtr<ID3D11Device>& device, const wchar_t* filename,
	Microsoft::WRL::ComPtr<ID3D11ShaderResourceView>& textureResourceView) {
